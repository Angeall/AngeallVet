...
Optional features are sold as **modules** unlocked per tenant by a **cryptographically signed license** (Ed25519), never a plain env flag. Single source of truth: `app/core/licensing.py` (`ALL_MODULES`, `MODULE_LABELS`). Current keys: `invoice_ninja`, `sms`, `google_calendar`, `accounting`.
